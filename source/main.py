...
def main(model, mcmc, rho, nu, sigma, delta, horizon, epochs):
    ...
    test_model = cnn.CNN
    params = cnn.CNN.get_search_space()
    # test_model = mlp.MLP
    ...
    for seed_id in range(mcmc):
        ...
        hyperband_finite.hyperband_finite(test_model, 'epochs', params, 1, 20, 360, director, data, eta=4,
                                          verbose=True)
        ...
        f_target_tpe = target.HyperCNN(test_model, epochs, director, data)
        ...
        best, results, track_valid, track_test = random_search.random_search(test_model, 'epochs', horizon,
                                                                             director, params,
...
if __name__ == "__main__":
    main('cnn', 1, 0.66, 1., 0.1, 0.05, 12, 15)
