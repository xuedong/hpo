...
if __name__ == "__main__":
    ...
    # plots.plot_all(paths, 3, 'mlp_', 'sgd_', 'mnist_bis_2', 0, 'epochs', type_plot='linear', devs=False)
    ...
    # path = "../result/hyperloop_logistic_1/"
    # plots.plot_hyperloop_only(path, 10, 'logistic_', 'sgd_', 'mnist', 1)
