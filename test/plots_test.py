...
if __name__ == "__main__":
    ...
    plots.plot_all(paths, 9, 'logistic_', 'sgd_', 'mnist_bis', 1, 'epochs', type_plot='linear', devs=False)
    ...
    # plots.plot_all(paths, 1, 'mlp_', 'sgd_', 'mnist_bis', 0, 'epochs', type_plot='linear', devs=False)
